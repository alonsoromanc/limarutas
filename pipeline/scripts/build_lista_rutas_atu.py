...
def main():
    ...
    overrides = {
        ...
        'AD-N':   {'empresa_operadora': 'AeroDirecto', 'empresa_abrev': 'AD',
                   'alias': 'Norte', 'color_hex': '#0657AC', 'fuente': 'manual',
                   'distrito_origen': 'Los Olivos', 'distrito_destino': 'Callao'},
        'AD-S':   {'empresa_operadora': 'AeroDirecto', 'empresa_abrev': 'AD',
                   'alias': 'Sur', 'color_hex': '#F22536', 'fuente': 'manual',
                   'distrito_origen': 'Pueblo Libre', 'distrito_destino': 'Callao'},
        'AD-C':   {'empresa_operadora': 'AeroDirecto', 'empresa_abrev': 'AD',
                   'alias': 'Centro', 'color_hex': '#3B82C4', 'fuente': 'manual',
                   'distrito_origen': 'Cercado de Lima', 'distrito_destino': 'Callao'},
